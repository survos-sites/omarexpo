 ...
 */
final class Version20241214112451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD COLUMN price INTEGER DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, project_id, attributes, filename, transcript, code, relative_path, title, description, duration, status, local_code, section_title, order_idx, stop_id, end_row, start_row, source_filename, visibility, short_code, asset_relative_path, views, audio, video, image, label, size, year, image_urls, audio_url, youtube_url FROM item');
        ...
        , audio_url VARCHAR(255) DEFAULT NULL, youtube_url VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_1F1B251E166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO item (id, project_id, attributes, filename, transcript, code, relative_path, title, description, duration, status, local_code, section_title, order_idx, stop_id, end_row, start_row, source_filename, visibility, short_code, asset_relative_path, views, audio, video, image, label, size, year, image_urls, audio_url, youtube_url) SELECT id, project_id, attributes, filename, transcript, code, relative_path, title, description, duration, status, local_code, section_title, order_idx, stop_id, end_row, start_row, source_filename, visibility, short_code, asset_relative_path, views, audio, video, image, label, size, year, image_urls, audio_url, youtube_url FROM __temp__item');
